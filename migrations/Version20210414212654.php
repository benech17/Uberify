 ...
 */
final class Version20210414212654 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE exercice ADD mean_feedback DOUBLE PRECISION DEFAULT NULL');
        $this->addSql('ALTER TABLE resolution CHANGE feedback feedback DOUBLE PRECISION DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE exercice DROP mean_feedback');
        $this->addSql('ALTER TABLE resolution CHANGE feedback feedback INT DEFAULT NULL');
    }
}
